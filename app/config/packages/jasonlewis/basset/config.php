...
return array(
    ...
    */
    ...
    'collections' => array(
        'main_css' => function($collection){
             $collection->requireTree('../assets/css')->apply('CssMin');
             
        },
        'main_js' => function($collection){

            $collection->javascript('../assets/js/jquery.min.js');
            //$collection->javascript('../assets/js/jquery-ui-1.10.4.custom.min.js');
            $collection->javascript('../assets/js/bootstrap.min.js');
            $collection->javascript('../assets/js/modern-business.js');
            $collection->javascript('../assets/js/bootstrapValidator.min.js');
            $collection->javascript('../assets/js/bootstrap-growl.js');
            $collection->javascript('../assets/js/bootbox.min.js');
            $collection->javascript('../assets/js/bootstrap-editable.min.js');
            $collection->javascript('../assets/js/summernote.min.js');
            $collection->javascript(url('jsconfig'))->apply('JsMin');
            
            //$collection->javascript('../assets/js/custom.js');
        },
