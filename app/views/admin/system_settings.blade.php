        ...
        <div class="container">
            <table class='table table-bordered table-striped'>
                ...
                <tr><td>Above Lesson Progressbar Content</td>
                    <td><input type="text" class="form-control inline" value="{{ sys_settings('above_progressbar_content') }}" onchange="ajax_update(this)" data-field="above_progressbar_content" id="above_progressbar_content" data-pk="1" 
