<div class="panel panel-success block list-row-{{$block->id}}" id="block-{{$block->id}}">
  ...
  <div class="panel-heading">
      <div class="col-lg-8">
          <span id="block-title-sxpan-{{$block->id}}">[#{{$block->id}}]
              Image Upload </span>
      </div>
      <div class="col-lg-4">
  ...
  <div class="panel-body">
     Instructions:
    <input type="text" class="form-control" id="block-title-{{$block->id}}" value="{{$block->title}}" placeholder="e.g. Please upload your logo" /><br />
